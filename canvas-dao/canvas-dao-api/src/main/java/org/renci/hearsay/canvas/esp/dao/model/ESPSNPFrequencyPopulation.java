...
@NamedQueries({
        @NamedQuery(name = "esp.ESPSNPFrequencyPopulation.findByLocationVariantIdAndVersion", query = "FROM ESPSNPFrequencyPopulation a join a.locationVariant b where b.id = :locationVariantId and a.key.version = :version") })
