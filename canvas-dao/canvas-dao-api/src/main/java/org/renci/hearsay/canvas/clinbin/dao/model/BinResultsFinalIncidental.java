...
@XmlType(name = "BinResultsFinalIncidental")
@XmlRootElement(name = "binResultsFinalIncidental")
@Entity
@Table(name = "bin_results_final_incidental")
public class BinResultsFinalIncidental {
