...
@Transactional
public class OneThousandGenomeSNPFrequencyPopulationDAOImpl
        extends BaseDAOImpl<OneThousandGenomeSNPFrequencyPopulation, Long>
    ...
    @Override
    public List<OneThousandGenomeSNPFrequencyPopulation> findByLocationVariantIdAndVersion(Long locVarId,
        ...
        TypedQuery<OneThousandGenomeSNPFrequencyPopulation> query = getEntityManager().createNamedQuery(
                "genome1k.SNPFrequencyPopulation.findByLocationVariantIdAndVersion",
                OneThousandGenomeSNPFrequencyPopulation.class);
