...
public class PullReferenceSequencesCallable implements Callable<Void> {

    private final Logger logger = LoggerFactory.getLogger(PullReferenceSequencesCallable.class);
    ...
    public PullReferenceSequencesCallable(CANVASDAOBeanService canvasDAOBeanService, HearsayDAOBeanService hearsayDAOBeanService,
    ...
    public Void call() {
        ...
        try {
            ...
            List<GenomeReference> genomeReferences = hearsayDAOBeanService.getGenomeReferenceDAO()
                    .findByIdentifierSystemAndValue("canvas/ref/genomeRef", genomeRefId.toString());
            ...
            if (CollectionUtils.isNotEmpty(foundTranscriptReferenceSequences)) {
                ...
                for (TranscriptMaps transcriptMaps : foundTranscriptReferenceSequences) {
                    ...
                    if (CollectionUtils.isNotEmpty(refSeqGeneList)) {
                        ...
                        List<Gene> geneList = hearsayDAOBeanService.getGeneDAO().findByIdentifierSystemAndValue("canvas/refseq/gene",
                    ...
                    Identifier identifier = new Identifier("canvas/refseq/transcript", versionedRefSeqAccession);
                    ...
                    // apparently canvas stores protein accession in the variant tables
                    ...
                    identifier = new Identifier("canvas/ref/genomeRefSeq", versionedGenomicAccession);
                    possibleIdentifiers = hearsayDAOBeanService.getIdentifierDAO().findByExample(identifier);
                    if (CollectionUtils.isNotEmpty(possibleIdentifiers)) {
                        identifier = possibleIdentifiers.get(0);
                    } else {
