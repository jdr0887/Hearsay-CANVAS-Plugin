...
@Command(scope = "canvas", name = "list-reference-sequences", description = "List Reference Sequences")
@Service
public class ListReferenceSequencesAction implements Action {
    ...
    @Argument(index = 0, name = "--system", required = true)
    ...
    public Object execute() {
        ...
        try {
            ...
            List<Identifier> identiferList = identifierDAO.findByExample(new Identifier(system, null));
